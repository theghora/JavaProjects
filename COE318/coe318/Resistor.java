...
public class Resistor {
     ...
     */
    public Resistor(double resistance,double voltage,double current) {
            volts = voltage;
            currents = current;
...
//FIX THIS
        return currents*currents*resistances;
    }
